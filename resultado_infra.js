document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            // Utiliza os dados para trocar a imagem na div
            const imageUrl = data.result[0].imagem;
            const imageElement = document.querySelector(".ComissaoSection1DiretorConteudoItensResultado .ImagemResultado");

            // Troca a imagem pela URL obtida
